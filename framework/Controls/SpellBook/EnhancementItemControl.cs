...
{
	public sealed partial class EnhancementItemControl : Control
	{
		[Export]
		...
		public EnhancementControl EnhancementControl { get; set; }
		...
		public override void _Ready()
		{
			...
			GuiInput += @event =>
			{
				if (@event is InputEventMouseButton { ButtonIndex: MouseButton.Left, Pressed: true } mb)
					EnhancementControl.SelectEnhancement(SpellInfo.SpellId);
			};
		}
